...
class BiodataDoctor extends StatefulWidget {
  const BiodataDoctor({super.key});

  @override
  State<BiodataDoctor> createState() => _BiodataDoctorState();
}

class _BiodataDoctorState extends State<BiodataDoctor> {
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const Text('Laki-laki', style: TextStyle(fontFamily: 'Poppins', fontSize: 16)),
                    Radio<int>(
                      value: 0,
                      groupValue: gender,
                      onChanged: (int? value) {
                    ...
                    const Text('Perempuan', style: TextStyle(fontFamily: 'Poppins', fontSize: 16)),
                  ],
                ),
                const SizedBox(height: 10),
                const Text(
                ...
                DropdownButtonFormField<Specialty>(
                  ...
                  items: getSpecialties().map((Specialty specialty) {
                    return DropdownMenuItem<Specialty>(
                      ...
                      child: Row(
                        children: [
                          Image.asset(specialty.imageUrl, width: 24, height: 24),
                          const SizedBox(width: 10),
                          Text(specialty.name, style: const TextStyle(fontFamily: 'Poppins', fontSize: 16)),
                        ],
                      ),
                    );
                  }).toList(),
...
class Specialty {
  ...
  bool operator ==(Object other) {
    ...
    return other is Specialty && other.name == name && other.imageUrl == imageUrl;
  }
